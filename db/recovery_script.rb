...
puts product_ids_characters.inspect
puts product_ids_colors.inspect

# products_characters = {}
# products_colors = {}
# ids_products = {}

# mongo_import('products.csv', products_characters, 'name', 'character')
# mongo_import('products.csv', products_colors, 'name', 'color')

# products_characters.each_pair do |key, value|
#   case value
#   when 'ObjectID(523f96ba02c82d5c32000007)', 'ObjectID(526b34d702c82d2f24000001)' #Elizabeth Purse, Elizabeth
#     products_characters[key] = characters['ObjectID(523f994202c82d5c3200000e)'] #Elizabeth Burke
#   when 'ObjectID(5258322502c82d4aad000006)', 'ObjectID(525ae4f702c82d4abc000034)' #Jones, Clinton
#     products_characters[key] = characters['ObjectID(523f9c6802c82d5c3200000f)'] #Clinton Jones
#   when 'ObjectID(526abeb802c82d4d4f000021)' #Diana
#     products_characters[key] = characters['ObjectID(523f9b7002c82d5c2900000a)'] #Diana Barrigan
#   when 'ObjectID(525ad57202c82d4ab9000028)' #Neal
#     products_characters[key] = characters['ObjectID(52012d857b1d3942f1000003)'] #Neal Caffrey
#   else
#     products_characters[key] = characters[value]
#   end
# end

# products_colors.each_pair do |key, value|
#   case value
#   when 'ObjectID(51b90ecb7b1d39541f000001)' #gray
#     products_colors[key] = colors['ObjectID(521bb3357b1d392b8a000004)'] #Gray
#   when 'ObjectID(51b9deef7b1d391249000001)' #blue
#     products_colors[key] = colors['ObjectID(51d4723a7b1d3942df000001)'] #Blue
#   when 'ObjectID(5268229302c82d4d52000004)' #silver bar
#     products_colors[key] = colors['ObjectID(52681e5402c82d4d58000002)'] #Silver
#   else
#     products_colors[key] = colors[value]
#   end
# end